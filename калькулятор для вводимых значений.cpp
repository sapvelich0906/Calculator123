// калькулятор для вводимых значений.cpp : Defines the entry point for the console application.
//

// калькулятор для заданных двух чисел.cpp : Defines the entry point for the console application.
//
